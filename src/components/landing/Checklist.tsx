...
const checklistItems = [
    { title: "Como ter uma mentalidade de sucesso", description: "A mentalidade necessária para empreender no digital." },
    { title: "Como escolher seu nicho de mercado ideal", description: "Os melhores nichos para atuar e como escolher o mais lucrativo para você." },
