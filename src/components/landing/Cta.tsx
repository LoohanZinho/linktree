    ...
    <section className="py-20 bg-black">
      <div className="container mx-auto px-4">
        <div className="relative bg-primary/90 text-black rounded-lg p-8 md:p-12 text-center max-w-4xl mx-auto overflow-hidden">
          ...
          <Button size="lg" variant="secondary" className="bg-white text-black font-bold text-lg w-full md:w-auto hover:bg-gray-200 relative z-10 shadow-lg hover:shadow-xl transition-shadow">
